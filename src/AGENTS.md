...
**产品 TUI（`src/app/tui`）**：**已开闸（2026-07-11）**。轨 B 至 **c492** 已归档；下一：`c493-add-app-tui-compaction-retry-ui`。引擎能力仍可在 `packages/xylitol-tui` / `agent_demo` 先行验证。c491 假树 stub 禁止扩活树。
