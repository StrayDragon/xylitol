#!/usr/bin/env python3
"""Sync / check playground + designing tokens + Palette vs DESIGN.md frontmatter.

SSOT: src/app/tui/DESIGN.md → colors.* (dark) + colors_light.* (light)

Writes (default): tokens.css, tokens.js next to this script AND
src/app/tui/designing/generated/.
Checks (--check): both dests + packages/xylitol-tui Palette::dark/light hex.
"""
...
DESIGNING_GEN = REPO / "src" / "app" / "tui" / "designing" / "generated"
...
def main() -> int:
    ...
    dests = (
        (HERE / "tokens.css", HERE / "tokens.js"),
