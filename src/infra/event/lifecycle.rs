...
//!
//! Every phase of the agent lifecycle emits a typed event with a meaningful
//! payload. Consumers (persistence, UI, extensions) subscribe to these events
//! via [`EventBus::on_lifecycle`].
