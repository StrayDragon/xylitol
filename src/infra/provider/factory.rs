...
/// Reset all mock state (BDD @executable fake-model surface; no product caller).
...
/// BDD @executable fake-model surface; no product caller.
#[allow(dead_code)] // BDD @executable contract, not product-called
...
/// BDD @executable fake-model surface; product uses `build_provider_with_hooks`.
#[allow(dead_code)] // BDD @executable contract, not product-called
