//! Prompt/input shaping — system prompt plus outbound AgentStatusBar.
//! The agent loop consumes these to build the input it sends to the model.
//!
...
pub use status_bar::{AgentStatusBar, project_outbound};
