...
> **状态：搁置（2026-08-22；2026-09-24 复核仍搁置）。** 编码主面是 gpui + TUI（见 [`Gpui桌面客户端.md`](./Gpui桌面客户端.md)）。本文仍是管控台愿景：复活时用 TS 页，Bun 做工具链，不是 Flutter，也不是编码主面。依据：[`../research/ui-runtime-tradeoffs-2026.md`](../research/ui-runtime-tradeoffs-2026.md)。复活需显式重立项。
...
| 远程干活 | 需要与本地同构的跑/改向/进度 | 薄端 + 同一驱动语义 |
...
| M2 对话 parity | 跑 / 流式 / 改向 / 中止与本地心智同构 |
| M3 审阅 | diff + 简易预览 |
