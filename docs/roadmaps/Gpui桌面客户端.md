...
> 方向定案：2026-08-22，2026-09-24 复核仍维持。编码主面是 gpui；Web（TS + Bun）只作搁置的管控台；Flutter 薄客户端排在 Rust 原生备选之后，不用 rinf 做总线。依据：[`../research/ui-runtime-tradeoffs-2026.md`](../research/ui-runtime-tradeoffs-2026.md)。
