...
| xylitol 产品架构             | `docs/architecture/库与多客户端.md`、`远程体验与线协议.md`、`会话与持久化.md`、`插话续跑与中止.md`、`工具与权限.md`、`信任与项目闸.md`、`压缩与上下文.md` |
