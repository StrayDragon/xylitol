...
> 现状对齐：2026-07-22（仅 config.yaml + secret.env）。
...
- **API 类型**：Pre-1.0 声明为 OpenAI 兼容（Completions 或 Responses）或 Anthropic。
...
| Pre-1.0 只接受 OpenAI 兼容（Completions / Responses）与 Anthropic | 为未交付厂商堆配置产品概念 |
