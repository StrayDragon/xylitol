...
完整术语 ↔ 代码标识符对照（grabbed/ungrabbed、视口 vs scrollback）：[`emulator-vs-app-selection-oneof.md`](../../llmanspec/changes/c2070-add-package-tui-dual-interaction-modes/research/emulator-vs-app-selection-oneof.md) §1。
