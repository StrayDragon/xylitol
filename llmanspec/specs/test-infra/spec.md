...
requirements[6]{req_id,title,statement}:
  ...
  r2,"test-harness","System MUST provide TestHarness Builder that wires all dependencies as mock or in-memory implementations for full-stack agent testing; MockToolContext MUST include workspace_root field."
