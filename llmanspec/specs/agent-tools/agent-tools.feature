...
功能: agent-tools
  ...
  @executable @req:r1133
  场景: span
    假如 oldText 跨 5 行但中间一行精确匹配失败
    当 以 span 匹配应用 edit
    那么 滑动窗口匹配成功

  @executable @req:r1145
