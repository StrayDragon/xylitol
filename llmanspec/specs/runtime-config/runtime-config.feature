...
功能: runtime-config
  ...
  @executable @req:r1741
  场景: field
    当 读取默认配置
    那么 mcp 未启用且字段可序列化

  @executable @req:r1727
  场景: parse-list
