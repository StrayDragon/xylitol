...
scenarios[2]{req_id,id,given,when,then}:
  ...
  r1,"minimal-build",Cargo.toml exists with updated default list,"cargo build --no-default-features --features ui-review is run","only ui-review and its dependencies are compiled"
```
