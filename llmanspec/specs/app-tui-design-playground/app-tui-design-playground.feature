...
功能: app-tui-design-playground
  ...
  场景: sync-runs
    当 运行 token 同步脚本
    那么 生成或刷新 designing/generated 的 tokens.css 与 tokens.js 且无报错
  ...
  @req:adp3
  场景: agents-pointer
    当 阅读 designing/AGENTS.md
    那么 写明 Agent 先读产品代码、默认读短模块、默认忽略 designing/app
  ...
  @req:adp6
  场景: qa-runs-lint
    当 运行 python3 scripts/check_tui_designing.py --check
