...
> **阶段**：Designed / pre-`change start`（**未分支**）。
> **Start readiness**：`blocked_on_c1760`（见文末）。
> **对照**：[`c1760`](../c1760-add-tui-activity-fold/proposal.md) · [`c2045`](../c2045-add-tui-fold-target-remaining/proposal.md) · [`c2040` archive](../archive/2026-08-12-c2040-add-tui-mouse-click-fold-triangle/) · [`research/multilevel-fold-interaction-matrix.md`](./research/multilevel-fold-interaction-matrix.md)
