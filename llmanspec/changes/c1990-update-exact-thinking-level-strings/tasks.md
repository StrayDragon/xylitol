...
- [x] 2.1 bridge：`canonical_known_level` → 精确匹配；单测覆盖 `HIGH`/` high `
- [x] 2.2 protocol：`thinking_levels_are_adjustable` 对 `off` 精确比较
- [x] 2.3 manager / 文档注释与 TUI 边框：确认展示模糊不影响档名回写

## 3. 验证

- [x] 3.1 bridge + lib 相关单测绿
