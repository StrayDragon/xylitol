...
|---|---|---|---|
| A TUI | `c2200-refactor-tui-kind-catalog-verify/` | [`PROMPT-activity-fold-scene.md`](./PROMPT-activity-fold-scene.md) | [`code-as-design-and-tui-verify.md`](./code-as-design-and-tui-verify.md) · [`tui-as-app-stable-vs-iterate.md`](./tui-as-app-stable-vs-iterate.md) |
