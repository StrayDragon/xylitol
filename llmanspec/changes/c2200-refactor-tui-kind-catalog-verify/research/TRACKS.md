...
|---|---|---|---|
| A TUI | `c2200-refactor-tui-kind-catalog-verify/` | [`PROMPT-activity-fold-scene.md`](./PROMPT-activity-fold-scene.md) · [`PROMPT-activity-atom.md`](./PROMPT-activity-atom.md) | [`code-as-design-and-tui-verify.md`](./code-as-design-and-tui-verify.md) · [`tui-as-app-stable-vs-iterate.md`](./tui-as-app-stable-vs-iterate.md) · [`scene-must-be-product-path.md`](./scene-must-be-product-path.md) |
